Original Vuetify Material Dashboard info below.

# Orderbook Wallet
Redesign of the [Orderbook.live](https://orderbook.live) demo of how to use the [atomicDEX API](https://atomicdex.io)
